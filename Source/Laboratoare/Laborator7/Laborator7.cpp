...
void Laborator7::Update(float deltaTimeSeconds)
{
...

	{
		...
		RenderSimpleMesh(meshes["box"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0.7, 0.3, 0));
	}
	...
	// Render the point light in the scene
	{
		...
		RenderSimpleMesh(meshes["sphere"], shaders["Simple"], modelMatrix,glm::vec3(0,0.5,0));
	}
}
